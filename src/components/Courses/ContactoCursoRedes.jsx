...
import { trackEvent } from "../../data/metaPixel";
...
const CRONOGRAMA = [
  {
    ...
    fecha: "13/10",
    modulo: "Módulo I",
    titulo: "Introducción a Servidores y Laboratorio Virtual",
  },
  {
    clase: 2,
    fecha: "14/10",
    modulo: "Módulo I",
    titulo: "Consola Linux (Bash) I: Navegación y Archivos",
  },
  {
    clase: 3,
    fecha: "20/10",
    modulo: "Módulo I",
    titulo: "Consola Linux (Bash) II: Permisos y Usuarios",
  },
  {
    clase: 4,
    fecha: "21/10",
    modulo: "Módulo I",
    titulo: "Gestión de Procesos Servicios y Paquetes",
  },
  {
    clase: 5,
    fecha: "27/10",
    modulo: "Módulo I",
    titulo: "Servidores Web Locales y Acceso Remoto SSH",
  },
  {
    clase: 6,
    fecha: "28/10",
    modulo: "Módulo I",
    titulo: "Práctica Integradora Linux & SysAdmin",
  },
  {
    clase: 7,
    fecha: "03/11",
    modulo: "Módulo II",
    titulo: "Introducción a Redes y el Modelo OSI",
  },
  {
    clase: 8,
    fecha: "04/11",
    modulo: "Módulo II",
    titulo: "Modelo TCP/IP y Encapsulamiento",
  },
  {
    clase: 9,
    fecha: "10/11",
    modulo: "Módulo II",
    titulo: "Direccionamiento IPv4 y Clases de Red",
  },
  {
    clase: 10,
    fecha: "11/11",
    modulo: "Módulo II",
    titulo: "Servicios Fundamentales: DNS y DHCP",
  },
  {
    clase: 11,
    fecha: "17/11",
    modulo: "Módulo II",
    titulo: "Capas de Transporte: TCP vs UDP e ICMP",
  },
  {
    clase: 12,
    fecha: "18/11",
    modulo: "Módulo II",
    titulo: "Cisco Packet Tracer I: Primeras Topologías",
  },
  {
    clase: 13,
    fecha: "24/11",
    modulo: "Módulo III",
    titulo: "Switched Networks: Capa de Enlace y MAC",
  },
  {
    clase: 14,
    fecha: "25/11",
    modulo: "Módulo III",
    titulo: "Configuración de Switches y VLANs en Cisco",
  },
  {
    clase: 15,
    fecha: "01/12",
    modulo: "Módulo III",
    titulo: "Fundamentos de Enrutamiento (Routing)",
  },
  {
    clase: 16,
    fecha: "02/12",
    modulo: "Módulo III",
    titulo: "Introducción al Subnetting / Subneteo IPv4",
  },
  {
    clase: 17,
    fecha: "08/12",
    modulo: "Módulo III",
    titulo: "Subneteo Práctico FLSM (Fixed Length)",
  },
  {
    clase: 18,
    fecha: "09/12",
    modulo: "Módulo III",
    titulo: "Subneteo Avanzado VLSM (Variable Length)",
  },
  {
    clase: 19,
    fecha: "15/12",
    modulo: "Módulo III",
    titulo: "Configuración de Routers en Packet Tracer",
  },
  {
    clase: 20,
    fecha: "16/12",
    modulo: "Módulo III",
    titulo: "Enrutamiento Dinámico (OSPF)",
  },
  {
    clase: 21,
    fecha: "22/12",
    modulo: "Módulo III",
    titulo: "Seguridad y Traducción de Direcciones (NAT/PAT)",
  },
  {
    clase: 22,
    fecha: "23/12",
    modulo: "Módulo III",
    titulo: "Taller Integrador de Redes en Packet Tracer",
  },
  {
    clase: 23,
    fecha: "29/12",
    modulo: "Módulo IV",
    titulo: "Introducción a la Nube y AWS IAM",
  },
  {
    clase: 24,
    fecha: "30/12",
    modulo: "Módulo IV",
    titulo: "Networking en la Nube: AWS VPC",
  },
  {
    clase: 25,
    fecha: "05/01",
    modulo: "Módulo IV",
    titulo: "Servidores Virtuales en Cloud: AWS EC2",
  },
  {
    clase: 26,
    fecha: "06/01",
    modulo: "Módulo IV",
    titulo: "Despliegue en EC2 & Web Hosting",
  },
  {
    clase: 27,
    fecha: "12/01",
    modulo: "Módulo IV",
    titulo: "Almacenamiento Cloud: AWS S3 y EBS",
  },
  {
    clase: 28,
    fecha: "13/01",
    modulo: "Módulo IV",
    titulo: "Bases de Datos Managed: AWS RDS",
  },
  {
    clase: 29,
    fecha: "19/01",
    modulo: "Módulo IV",
    titulo: "Alta Disponibilidad: Load Balancers y Auto Scaling",
  },
  {
    clase: 30,
    fecha: "20/01",
    modulo: "Módulo IV",
    titulo: "Arquitectura Cloud Multi-capa",
  },
  {
    clase: 31,
    fecha: "26/01",
    modulo: "Módulo IV",
    titulo: "Despliegue de Infraestructura Cloud Integrada",
  },
  {
    clase: 32,
    fecha: "27/01",
    modulo: "Módulo IV",
    titulo: "Pruebas de Carga Optimización de Costos y Cierre",
  },
];
          ...
          <div className={styles.cardContainer}>
            <div className={styles.header}>
              ...
              <p className={styles.description}>
                Aprende Administración Linux, Redes TCP/IP, Subneteo y
                Despliegue en AWS desde cero con laboratorios reales.
              </p>

              <div className={styles.promoCard}>
                <div className={styles.promoBadge}>
                  🔥 66% OFF - BECA DERECHO DE EXAMEN
                </div>
                ...
                <div className={styles.monthlyPerk}>
                  💡 Equivale a solo <strong>$20.000 / mes</strong> durante los
                  4 meses del curso.
                </div>
              </div>
            ...
            {!submitted ? (
              ...
              <div className={styles.successMessage}>
                ...
                <p>
                  Nos pondremos en contacto contigo para congelar tu precio
                  promocional.
                </p>
              </div>
            )}
          ...
          <div className={styles.modulesSummary}>
            ...
            <div className={styles.modulesGrid}>
              <div className={styles.moduleCard}>
                ...
                <p>
                  Consola Bash, gestión de permisos, usuarios, servicios y SSH.
                </p>
              </div>
              <div className={styles.moduleCard}>
              ...
              <div className={styles.moduleCard}>
                ...
                <p>
                  AWS EC2, VPC, S3, RDS, Auto Scaling y arquitectura multicapa.
                </p>
              </div>
            </div>
          </div>
